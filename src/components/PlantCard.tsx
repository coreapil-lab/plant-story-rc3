  ...
  return (
    ...
    >
      <div className="ps-card-photo-frame">
        {plant.imageUrl ? (
          <img className="ps-card-photo" src={plant.imageUrl} alt={plant.name} />
        ) : (
          <div className="ps-card-placeholder" aria-hidden="true">🌿</div>
        )}

        <div className="ps-card-quick-actions">
          <button
            type="button"
            className="ps-card-quick-button ps-card-fertilizer-button"
            onClick={(event) => void handleQuickAction(event, "fertilizer")}
          ...
          <button
            type="button"
            className="ps-card-quick-button ps-card-water-button"
            onClick={(event) => void handleQuickAction(event, "water")}
            disabled={quickAction !== null}
      ...
      <div className="ps-card-content">
        <div className="ps-card-heading">
          ...
          <div className="ps-card-nickname">{plant.nickname || "별명 없음"}</div>
        </div>
        <div className="ps-card-divider" />
        <div className="ps-card-care-list">
          <div className="ps-card-care-row">
            <span className="ps-card-care-label"><span className="ps-card-care-icon" aria-hidden="true">💧</span>물주기</span>
            <strong className="ps-card-care-value ps-card-care-value-water">{formatDPlus(wateredDays)}</strong>
          </div>
          <div className="ps-card-care-row">
            <span className="ps-card-care-label"><span className="ps-card-care-icon" aria-hidden="true">🌱</span>영양제</span>
            <strong className="ps-card-care-value">{formatDPlus(fertilizedDays)}</strong>
          </div>
        </div>
      </div>
    </div>
